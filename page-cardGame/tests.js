...
function incrementCounterTest() {
  ...
  if (value1 !== 1) {
    console.error(`${ERROR}should place '1' in parent (counter should increase to 1) after first call but got '${string1}'` + "val");
    return false;
  }
  ...
  if (value3 !== 1) {
    console.error(`${ERROR}should place '1' in parent after first call with new counterName but got '${string3}' + "val"`);
    return false;
  }
