...
// create card object
const card = {
  manipulate: document.querySelector("div"),
  children: '<div class="card-down"></div><div class="card-up"></div>',
  setManipulation : function(){
    this.manipulate.classList.add("card");
    this.manipulate.innerHTML = this.children;
  }
 };
card.setManipulation();
parentElement.appendChild(card.manipulate);
return card.manipulate;
